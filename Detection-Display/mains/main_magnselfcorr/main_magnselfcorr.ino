...
const int  MICROSTEPS = 8; // motor drive is rated 32 segments
...
const float TARGET_RPM = 100.0; // revs/min NOT sure what this should be
...
void loop(){
  if (start == false){
    ...
    spin90WithCorrection(stepper, STEPS_PER_REV, ENCODER_PIN, -1);   //-1 for cw
