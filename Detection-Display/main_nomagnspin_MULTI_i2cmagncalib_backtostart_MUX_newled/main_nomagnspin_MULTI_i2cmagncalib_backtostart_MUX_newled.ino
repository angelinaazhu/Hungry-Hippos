...
// sensor1
const double colorAvgR_1[NUM_COLORS] = {5.0000, 18.0000, 130.9000,
                                        // 132.9000
                                        11.3000, 57.0000,
                                        // 159.2000,
                                        37.0000, 48.0000, 239.0000};
const double colorAvgG_1[NUM_COLORS] = {19.0000, 81.0000, 203.5000,
                                        // 253.4500,
                                        39.1500, 47.1000,
                                        // 173.8500,
                                        61.9000, 144.0000, 169.0000};
const double colorAvgB_1[NUM_COLORS] = {17.0000, 161.2500, 94.3000,
                                        // 254.0500,
                                        88.0000, 39.0000,
                                        // 196.4500,
                                        114.0000, 83.0000, 93.0000};

// sensor2
const double colorAvgR_2[NUM_COLORS] = {7.0000, 25.0000, 232.5500,
                                        // 219.5500
                                        19.0500, 66.2000,
                                        // 206.7500
                                        46.3000, 75.8000, 245.2000};
const double colorAvgG_2[NUM_COLORS] = {11.0000, 78.7500, 240.0000,
                                        // 255.0000,
                                        36.0000, 25.0000,
                                        // 146.3500,
                                        47.8000, 156.9000, 112.6500};
const double colorAvgB_2[NUM_COLORS] = {8.0000, 161.3500, 104.0000,
                                        // 255.0000,
                                        86.1000, 19.0000,
                                        // 175.6500,
                                        95.3000, 81.5500, 63.7500};

// human-friendly names in same order as calibration
const char* colorNames[NUM_COLORS] = {"NO BALL", "LIGHT BLUE", "YELLOW",
                                      //"WHITE",
                                      "DARK BLUE", "RED",
                                      //"PINK",
                                      "PURPLE", "GREEN", "ORANGE"};
// points assigned per color (customize as desired)
const int pointsPerColor[NUM_COLORS] = {0, 5, 5,
                                        // 5,
                                        5, -5,
                                        // 5,
                                        5, 10, 5};
