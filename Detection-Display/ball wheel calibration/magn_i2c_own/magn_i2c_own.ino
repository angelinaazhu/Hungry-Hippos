...
void setup(){
  ...
  startAngle = absAngle; //update startAngle with absAngle reading
...
void getRelativeAngle(){
  //recalculate angle
  relAngle = absAngle - startAngle; //this tares the position
...
void checkRotated90(int direction) {
