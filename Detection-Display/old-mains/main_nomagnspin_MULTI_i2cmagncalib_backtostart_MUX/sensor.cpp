...
void classify(const unsigned long VOTING_WINDOW, const unsigned long VOTING_INTERVAL, Adafruit_NeoPixel& strip, SFE_ISL29125& RGB_sensor, int player, Adafruit_7segment& hex_points, int& points,
