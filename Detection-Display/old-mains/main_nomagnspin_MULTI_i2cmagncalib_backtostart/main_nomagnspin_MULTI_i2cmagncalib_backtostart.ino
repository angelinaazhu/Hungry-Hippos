...
const unsigned int redMin = 49;
const unsigned int redMax = 4524;
const unsigned int greenMin = 133;
const unsigned int greenMax = 3277;
const unsigned int blueMin = 153;
const unsigned int blueMax = 5030;
